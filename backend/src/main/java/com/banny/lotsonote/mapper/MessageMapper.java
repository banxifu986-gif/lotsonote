...
import com.banny.lotsonote.model.vo.message.UnreadCountByType;
...
public interface MessageMapper {
     ...
     * @return 消息列表
     */
    List<Message> selectByParams(@Param("userId") Long userId, @Param("params") MessageQueryParams params, @Param("limit") int limit, @Param("offset") int offset);
