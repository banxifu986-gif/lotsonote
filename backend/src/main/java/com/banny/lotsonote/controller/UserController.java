...
public class UserController {
    ...
    public ApiResponse<RegisterVO> register(
        ...
        return userService.register(request, getClientIp(httpServletRequest));
    }
    ...
    public ApiResponse<LoginUserVO> login(
            ...
            HttpServletRequest httpServletRequest) {
        return userService.login(request, getClientIp(httpServletRequest));
    }
    ...
    public ApiResponse<List<AdminUserVO>> adminGetUser(
